...
account name) -- a small, standalone app, launched via the `preferences`
subcommand, separate from tag_tui.py's TagApp since it's a wholly
different concern (account settings, not tagging) with no reason to share
a screen stack with it.
